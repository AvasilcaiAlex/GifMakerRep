        ...
        private void pictureBox13_Click(object sender, EventArgs e)
        {
            if (comboBox3.SelectedItem != null)
            {
                ...
                if (comboBox3.SelectedIndex == 0)
                {
                    ...
                    {
                        zoomFactor = 1.5;
                        newimeg = new Bitmap(imeg.Width, imeg.Height);
                        Graphics g = Graphics.FromImage(newimeg);
                        int newwidth = Convert.ToInt32(pictureBox2.Width * zoomFactor);
                        int newheight = Convert.ToInt32(pictureBox2.Height * zoomFactor);
                        Rectangle r = new Rectangle(0, 0, newwidth, newheight);
                        g.DrawImage(imeg, r);
                        pictureBox2.Image = newimeg;
                    }
            ...
            {
                MessageBox.Show("Trebuie sa selectati o marime scalara pentru a putea aplica zoom-ul!");
            }
        }
